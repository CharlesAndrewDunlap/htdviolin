...
export default function Home() {
  ...
  const shortBio2: string = ' In addition to performing, Davidson is an avid educator certified through the Suzuki Association of the Americas and on faculty at the Paganini School of Music  and the Small Victories Foundation, a nonprofit helping people with traumatic brain injuries. In her spare time, Davidson enjoys working on her passion projects including the study of Argentine tango music and composition.';
